...
This fork aims to expand the monitor's capabilities, enabling the generation and management of certificates... oh, wait, but then it wouldn't be just a monitor anymore 🤔
